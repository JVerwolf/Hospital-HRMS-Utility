 ...
 */
public class OldQueue<T> implements QueueADT<T>, DataStructure<T>,Serializable {
     ...
     */
    public OldQueue<T> copy() {
        return new OldQueue<>(front);
    }
     ...
     */
    private OldQueue(LinearNode<T> passedFront) {
