 ...
 */
public class ListWorker<T> implements ListADT<T>, Iterable<T>, DataStructure<T>, Serializable {

    /**
     * Stores the number of elements in the Linked ListWorker *
     */
    protected int count;
    /**
     ...
     *
     * @param element the element being added to the Linked ListWorker
     */
     ...
     *
     * @param element the element to be added to the Linked ListWorker
     */
...
//    }
     ...
     * @returns a shallow copy of the instance of the linked list
     */
    public ListWorker<T> copy() {
        return new ListWorker<>(head);
    }
     ...
     */
    private ListWorker(LinearNode<T> passedHead) {
    ...
    public void reverse(LinearNode<T> passedHead) {
        LinearNode<T> ReversedList = new LinearNode<>();            //New list that will be built from reversed passed ListWorker
        LinearNode<T> ReversedListProbe = ReversedList;            //New list that will be built from reversed passed ListWorker
