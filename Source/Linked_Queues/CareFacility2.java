 ...
 * @author John Verwolf
 */
public class CareFacility2 extends Company {
     ...
     */
    public CareFacility2(String facilityName, ArrayStack<Patient> patientStack, LinkedList<Bed> bedList, LinkedQueue<CasualEmployee> casualEmployee) {
     ...
     * @param casualEmployee An linked list of hourly employees
     */
    public CareFacility2(String facilityName, LinkedQueue<CasualEmployee> casualEmployee) {
        this.facilityName = facilityName;
        this.casualEmployee = casualEmployee;
        bedList = new LinkedList<>();
        patientStack = new ArrayStack<>();
